...
export default function RegistrationPagePublic() {
            ...
            >
              ...
              <div className=" pt-5">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className=" pb-3">
                    <p className=" text-sm pb-1 font-semibold">Kota</p>
                    <input
                      type="text"
                      name="ikpi_branch"
                  ...
                  <div className=" pb-3">
                    <p className=" text-sm pb-1 font-semibold">Kampus</p>
                    <input
                      type="text"
                      name="company"
                      value={form.company}
